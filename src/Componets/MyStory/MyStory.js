    ...
    render() {
        ...
        return (
            <main className="main-story">
                ...
                <p data-aos="fade-left" className="story-p" aria-label={p2}> <Ft>{p2}</Ft></p>
                ...
                <h1 data-aos="zoom-in" className='story-h1' aria-label='So how exactly did I get into coding?'><FunkyHeader text="So how exactly did I get into coding?"/></h1>
                ...
                <p data-aos="fade-down" className="story-p" aria-label={p7}> <Ft>{p7}</Ft> </p>
                ...
                <p data-aos="flip-up"
                    ...
                    <span
                        ...
                        title="Development of a web-GIS application. The case of ArcGIS server for the city of  Komotini"><Ft>
                        &nbsp;thesis&nbsp;</Ft>
                    </span>
                    <Ft>
                ...
                <p data-aos="flip-up" className="story-p" aria-label={p12}><Ft>{p12}</Ft></p>
                ...
                <p data-aos="fade-up" className="story-p" aria-label={p15}><Ft>{p15}</Ft></p>
