...
function Sempernote() {
  const goalsData = [
    ...
    "When in note editing mode the content of the note is auto-saved (and uploaded to the database) each 2000 seconds after the user stops typing or presses the back or the save button"
  ];
  ...
  const approach2 = `Next step was to create a schema to connect the collections together: `;
      ...
      <article className="prj-pg-details-article">
        ...
        </p>
        {
          <ul>
            ...
            <li aria-label="each notebook in Notebooks collections is connected with the user that owns the notebook and it also holds a reference to the individual notes from the Notes collection that it owns.">
              <Ft>
                ...
                individual notes from the Notes collection that it owns.
              </Ft>
            </li>
